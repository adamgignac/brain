...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "mapping.context_processors.workspace_list",
            ]
        },
    }
]
...
if os.environ.get("AUTH_URL"):
    ...
    LDAP_AUTH_URL = os.environ.get("AUTH_URL", "")
    LDAP_AUTH_SEARCH_BASE = os.environ.get("AUTH_SEARCH_BASE", "")
    LDAP_AUTH_OBJECT_CLASS = os.environ.get("AUTH_USER_CLASS", "inetOrgPerson")
...
LOGGING = {
    ...
    "loggers": {"django_python3_ldap": {"handlers": ["console"], "level": "INFO"}},
}
